    ...
    <>
      <div className="m-0 md:m-12 flex flex-col w-full">
        ...
        <div className="w-full flex-1 mt-8">
          ...
          <div>
            <Link to={"/auth/sendlink"} type="button" className="text-white mt-10 bg-dark text-light text-center w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm p-3  focus:outline-none ">
              Change Password
            </Link>
          </div>
